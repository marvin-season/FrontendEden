    ...
    return <>
        <Flex gap={6} className={'p-2'} justify={"flex-start"}>
            ...
            <div
                ...
                {
                    answer.type === MessageType.Loading ?
                        <div className={'bg-green-500 p-4'}></div> : typeof answer.content === 'string' ?
                            <Markdown style={{background: "none"}} source={answer.content}></Markdown> : ''
